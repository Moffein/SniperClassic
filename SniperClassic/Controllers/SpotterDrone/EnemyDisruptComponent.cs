			...
			foreach (RaycastHit rh in array)
			{
				...
				if (collider.gameObject)
				{
					...
					if (component)
					{
						...
						if (healthComponent && healthComponent.body && healthComponent.body.isChampion && healthComponent.body.master && healthComponent.body.teamComponent && healthComponent.body.teamComponent.teamIndex == victimTeamIndex)
						{
