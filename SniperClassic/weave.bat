...
set TargetFileName=SniperClassic.dll
...
REM in your postbuilds just put [call "$(ProjectDir)weave.bat"]
REM then add your other postbuilds in vs like it's any other project