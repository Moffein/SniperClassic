...
namespace SniperClassic.Modules.Achievements
{
    public static class SniperUnlockables
    {
        ...
        {
            //CharacterUnlockableDef = Config.forceUnlock ? null : Unlockables.AddUnlockable<EnforcerUnlockAchievement>(typeof(EnforcerUnlockAchievement.EnforcerUnlockAchievementServer));
